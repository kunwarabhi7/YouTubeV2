...
<div className='flex relative text-white'>
         ...
         <input value={search} onChange={(e)=> setSearch(e.target.value)}  type="text" className='border text-white border-gray-500 rounded-full w-18 md:w-[30rem]  rounded-r-none h-8 px-4 bg-black' placeholder='Search' />
